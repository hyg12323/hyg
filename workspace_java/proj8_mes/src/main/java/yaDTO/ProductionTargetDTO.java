...
public class ProductionTargetDTO {
	...
	public String toString() {
		return "ProductionTargetDTO [target_id=" + target_id + ", item_id=" + item_id + ", period_start=" + period_start
				+ ", period_end=" + period_end + ", target_quantity=" + target_quantity + ", created_at=" + created_at
